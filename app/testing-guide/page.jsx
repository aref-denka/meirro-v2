...
const specs = [
  ...
  },
  {
    ...
    value: '≤ 2.0',
    unit: 'ΔE',
    how: 'Run the greyscale and colour accuracy test. The software calculates Delta E (ΔE) — a number that measures how far each displayed colour is from its target. Under 2.0 is considered accurate; anything above means recalibration is needed.',
  },
];
    ...
    <div style={{ background: '#04040A' }} className="min-h-screen text-white">
      ...
      >
        <div className="max-w-[960px] mx-auto flex items-center justify-between px-6" style={{ height: 52 }}>
          <div className="flex items-center gap-2.5">
            <Link href="/" className="text-[17px] font-bold tracking-[-0.04em] text-white">Meirro</Link>
            <span className="text-white/20">/</span>
            <span className="text-[13px] font-medium text-white/45">Testing Guide</span>
          </div>
          <Link
            href="/"
      ...
      <div className="max-w-[960px] mx-auto px-6 py-10">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="p-6">
              ...
              <div
                className="flex items-start gap-3 p-4 rounded-xl border border-yellow-500/20"
              ...
              >
                ...
                <p className="text-[12px] leading-relaxed text-white/45">
                  <span className="font-semibold" style={{ color: 'rgba(252,211,77,0.90)' }}>If any metric falls outside these targets, </span>
                  run a full recalibration before using the display for colour-critical work.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 pt-5 border-t border-white/[0.06] flex items-center justify-between">
          <p className="text-[11px] text-white/20">© 2026 Meirro Technologies</p>
          <Link
            href="/"
