  ...
  return (
    <article className="prose-legal">
      ...
      <Section title="3. Shipping and Delivery">
        ...
        <p>Risk of loss passes to the buyer upon handover to the carrier. If your order arrives damaged, contact us within 48 hours of delivery at <a href="mailto:support@clickclack.io" className="text-[#7C5CFC] hover:underline">support@clickclack.io</a>.</p>
      </Section>
      ...
      <Section title="9. Contact">
        <p>Questions about these Terms? Reach us at <a href="mailto:support@clickclack.io" className="text-[#7C5CFC] hover:underline">support@clickclack.io</a>.</p>
      </Section>
    </article>
  );
}
